module github.com/joeyloman/rancher-fip-api-server
...
require (
	...
	github.com/rancher/rancher/pkg/apis v0.0.0-20251030105332-f0e856e503c1
...
exclude k8s.io/api v12.0.0+incompatible

exclude k8s.io/apimachinery v12.0.0+incompatible
